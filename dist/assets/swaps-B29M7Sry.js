import{u as $,t as I,$ as C,L as h,x as c,a6 as K,X as O,Q as y,a3 as L,a1 as M,ae as F,Y as Q,Z as q,I as B,J as H}from"./chain_config-D8DYnceI.js";import{r as a,n as g}from"./class-map-gEppeFCC.js";import{c as A}from"./index-CAF11AxJ.js";import"./index-CLIq9jXF.js";import"./index-BP5oJskm.js";import{M as U}from"./index-DOI4PMOy.js";import"./index-DC2MZbTQ.js";import{S as n}from"./SwapController-CVOa-9L-.js";import"./index-CSdExni1.js";import"./index-C9XBUklc.js";import"./index-YqlQsqF-.js";import"./index-BBtbNsVY.js";import"./index-DSM72A0H.js";import"./async-directive-vLOJ1iU1.js";import"./index-S9s5RHv-.js";import"./if-defined-B79U8La_.js";import"./ref-Dfiam_TO.js";const G={numericInputKeyDown(l,e,t){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=l.metaKey||l.ctrlKey,i=l.key,r=i.toLocaleLowerCase(),u=r==="a",D=r==="c",W=r==="v",z=r==="x",_=i===",",j=i===".",N=i>="0"&&i<="9";!s&&(u||D||W||z)&&l.preventDefault(),e==="0"&&!_&&!j&&i==="0"&&l.preventDefault(),e==="0"&&N&&(t(i),l.preventDefault()),(_||j)&&(e||(t("0."),l.preventDefault()),(e?.includes(".")||e?.includes(","))&&l.preventDefault()),!N&&!o.includes(i)&&!j&&!_&&l.preventDefault()}},Y=$`
  :host {
    width: 100%;
  }
...
`;var b=function(l,e,t,o){var s=arguments.length,i=s<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(l,e,t,o);else for(var u=l.length-1;u>=0;u--)(r=l[u])&&(i=(s<3?r(i):s>3?r(e,t,i):r(e,t))||i);return s>3&&i&&Object.defineProperty(e,t,i),i};const X=K.CONVERT_SLIPPAGE_TOLERANCE;let m=class extends I{constructor(){super(),this.unsubscribe=[],this.networkName=C.state.activeCaipNetwork?.name,this.detailsOpen=!1,this.sourceToken=n.state.sourceToken,this.toToken=n.state.toToken,this.toTokenAmount=n.state.toTokenAmount,this.sourceTokenPriceInUSD=n.state.sourceTokenPriceInUSD,this.toTokenPriceInUSD=n.state.toTokenPriceInUSD,this.priceImpact=n.state.priceImpact,this.maxSlippage=n.state.maxSlippage,this.networkTokenSymbol=n.state.networkTokenSymbol,this.inputError=n.state.inputError,this.unsubscribe.push(n.subscribe(e=>{this.sourceToken=e.sourceToken,this.toToken=e.toToken,this.toTokenAmount=e.toTokenAmount,this.priceImpact=e.priceImpact,this.maxSlippage=e.maxSlippage,this.sourceTokenPriceInUSD=e.sourceTokenPriceInUSD,this.toTokenPriceInUSD=e.toTokenPriceInUSD,this.inputError=e.inputError}))}render(){const e=this.toTokenAmount&&this.maxSlippage?h.bigNumber(this.toTokenAmount).minus(this.maxSlippage).toString():null;if(!this.sourceToken||!this.toToken||this.inputError)return null;const t=this.sourceTokenPriceInUSD&&this.toTokenPriceInUSD?1/this.toTokenPriceInUSD*this.sourceTokenPriceInUSD:0;return c`
    ...
    `}toggleDetails(){this.detailsOpen=!this.detailsOpen}};m.styles=[Y];b([a()],m.prototype,"networkName",void 0);b([g()],m.prototype,"detailsOpen",void 0);b([a()],m.prototype,"sourceToken",void 0);b([a()],m.prototype,"toToken",void 0);b([a()],m.prototype,"toTokenAmount",void 0);b([a()],m.prototype,"sourceTokenPriceInUSD",void 0);b([a()],m.prototype,"toTokenPriceInUSD",void 0);b([a()],m.prototype,"priceImpact",void 0);b([a()],m.prototype,"maxSlippage",void 0);b([a()],m.prototype,"networkTokenSymbol",void 0);b([a()],m.prototype,"inputError",void 0);m=b([A("w3m-swap-details")],m);const Z=$`
  :host {
    width: 100%;
  }
...
`;var V=function(l,e,t,o){var s=arguments.length,i=s<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(l,e,t,o);else for(var u=l.length-1;u>=0;u--)(r=l[u])&&(i=(s<3?r(i):s>3?r(e,t,i):r(e,t))||i);return s>3&&i&&Object.defineProperty(e,t,i),i};let E=class extends I{constructor(){super(...arguments),this.target="sourceToken"}render(){return c`
    ...
    `}};E.styles=[Z];V([g()],E.prototype,"target",void 0);E=V([A("w3m-swap-input-skeleton")],E);const J=$`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`;var v=function(l,e,t,o){var s=arguments.length,i=s<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(l,e,t,o);else for(var u=l.length-1;u>=0;u--)(r=l[u])&&(i=(s<3?r(i):s>3?r(e,t,i):r(e,t))||i);return s>3&&i&&Object.defineProperty(e,t,i),i};const ee=5e-5;let x=class extends I{constructor(){super(...arguments),this.focused=!1,this.price=0,this.target="sourceToken",this.onSetAmount=null,this.onSetMaxValue=null}render(){const e=this.marketValue||"0",t=h.bigNumber(e).gt("0");return c`
    ...
    </button>`}onFocusChange(e){this.focused=e}onSelectToken(){O.sendEvent({type:"track",event:"CLICK_SELECT_TOKEN_TO_SWAP"}),y.push("SwapSelectToken",{target:this.target})}onBuyToken(){y.push("OnRampProviders")}};x.styles=[J];v([g()],x.prototype,"focused",void 0);v([g()],x.prototype,"balance",void 0);v([g()],x.prototype,"value",void 0);v([g()],x.prototype,"price",void 0);v([g()],x.prototype,"marketValue",void 0);v([g()],x.prototype,"disabled",void 0);v([g()],x.prototype,"target",void 0);v([g()],x.prototype,"token",void 0);v([g()],x.prototype,"onSetAmount",void 0);v([g()],x.prototype,"onSetMaxValue",void 0);x=v([A("w3m-swap-input")],x);const te=$`
...
`;var P=function(l,e,t,o){var s=arguments.length,i=s<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(l,e,t,o);else for(var u=l.length-1;u>=0;u--)(r=l[u])&&(i=(s<3?r(i):s>3?r(e,t,i):r(e,t))||i);return s>3&&i&&Object.defineProperty(e,t,i),i};let S=class extends I{constructor(){super(),this.observer=new IntersectionObserver(()=>{}),this.imageSrc=void 0,this.name=void 0,this.symbol=void 0,this.price=void 0,this.amount=void 0,this.visible=!1,this.imageError=!1,this.observer=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting?this.visible=!0:this.visible=!1})},{threshold:.1})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){if(!this.visible)return null;const e=this.amount&&this.price?h.multiply(this.price,this.amount)?.toFixed(3):null;return c`
    ...
    `}visualTemplate(){return this.imageError?c`<wui-flex class="token-item-image-placeholder">
      ...
      ></wui-image>`:null}imageLoadError(){this.imageError=!0}};S.styles=[B,H,oe];P([g()],S.prototype,"imageSrc",void 0);P([g()],S.prototype,"name",void 0);P([g()],S.prototype,"symbol",void 0);P([g()],S.prototype,"price",void 0);P([g()],S.prototype,"amount",void 0);P([a()],S.prototype,"visible",void 0);P([a()],S.prototype,"imageError",void 0);S=P([A("wui-token-list-item")],S);const ne=$`
  :host > wui-flex:first-child {
    column-gap: var(--wui-spacing-s);
...
`;var se=function(l,e,t,o){var s=arguments.length,i=s<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(l,e,t,o);else for(var u=l.length-1;u>=0;u--)(r=l[u])&&(i=(s<3?r(i):s>3?r(e,t,i):r(e,t))||i);return s>3&&i&&Object.defineProperty(e,t,i),i};let R=class extends I{render(){return c`
      <wui-flex alignItems="center">
    ...
    `}};R.styles=[B,ne];R=se([A("wui-token-list-item-loader")],R);const re=$`
  :host {
