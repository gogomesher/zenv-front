...
import{u as k,r as y,t as x,x as E,k as h,v as f,_ as r,o as Z}from"./chain_config-D8DYnceI.js";import{n as s,a as A}from"./class-map-gEppeFCC.js";const L=".",v={getSpacingStyles(t,e){if(Array.isArray(t))return t[e]?`var(--apkt-spacing-${t[e]})`:void 0;if(typeof t=="string")return`var(--apkt-spacing-${t})`},getFormattedDate(t){return new Intl.DateTimeFormat("en-US",{month:"short",day:"numeric"}).format(t)},formatCurrency(t=0,e={}){const i=Number(t);return isNaN(i)?"$0.00":new Intl.NumberFormat("en-US",{style:"currency",currency:"USD",minimumFractionDigits:2,maximumFractionDigits:2,...e}).format(i)},getHostName(t){try{return new URL(t).hostname}catch{return""}},getTruncateString({string:t,charsStart:e,charsEnd:i,truncate:o}){return t.length<=e+i?t:o==="end"?`${t.substring(0,e)}...`:o==="start"?`...${t.substring(t.length-i)}`:`${t.substring(0,Math.floor(e))}...${t.substring(t.length-Math.floor(i))}`},generateAvatarColors(t){const i=t.toLowerCase().replace(/^0x/iu,"").replace(/[^a-f0-9]/gu,"").substring(0,6).padEnd(6,"0"),o=this.hexToRgb(i),n=getComputedStyle(document.documentElement).getPropertyValue("--w3m-border-radius-master"),a=100-3*Number(n?.replace("px","")),p=`${a}% ${a}% at 65% 40%`,d=[];for(let u=0;u<5;u+=1){const m=this.tintColor(o,.15*u);d.push(`rgb(${m[0]}, ${m[1]}, ${m[2]})`)}return`
    --local-color-1: ${d[0]};
    --local-color-2: ${d[1]};
    --local-color-3: ${d[2]};
    --local-color-4: ${d[3]};
   ...
   `},hexToRgb(t){const e=parseInt(t,16),i=e>>16&255,o=e>>8&255,n=e&255;return[i,o,n]},tintColor(t,e){const[i,o,n]=t,l=Math.round(i+(255-i)*e),a=Math.round(o+(255-o)*e),p=Math.round(n+(255-n)*e);return[l,a,p]},isNumber(t){return{number:/^[0-9]+$/u}.number.test(t)},getColorTheme(t){return t||(typeof window<"u"&&window.matchMedia&&typeof window.matchMedia=="function"?window.matchMedia("(prefers-color-scheme: dark)")?.matches?"dark":"light":"dark")},splitBalance(t){const e=t.split(".");return e.length===2?[e[0],e[1]]:["0","00"]},roundNumber(t,e,i){return t.toString().length>=e?Number(t).toFixed(i):t},cssDurationToNumber(t){return t.endsWith("s")?Number(t.replace("s",""))*1e3:t.endsWith("ms")?Number(t.replace("ms","")):0},maskInput({value:t,decimals:e,integers:i}){if(t=t.replace(",","."),t===L)return`0${L}`;const[o="",n]=t.split(L).map(m=>m.replace(/[^0-9]/gu,"")),l=i?o.substring(0,i):o,a=l.length===2?String(Number(l)):l,p=typeof e=="number"?n?.substring(0,e):n,d=typeof e!="number"||e>0;return(typeof p=="string"&&d?[a,p].join(L):a)??""},capitalize(t){return t?t.charAt(0).toUpperCase()+t.slice(1):""}};function I(t,e){const{kind:i,elements:o}=e;return{kind:i,elements:o,finisher(n){customElements.get(t)||customElements.define(t,n)}}}function T(t,e){return customElements.get(t)||customElements.define(t,e),e}function P(t){return function(i){return typeof i=="function"?T(t,i):I(t,i)}}const D=k`
  :host {
    display: flex;
    width: inherit;
    height: inherit;
...
`;var g=function(t,e,i,o){var n=arguments.length,l=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")l=Reflect.decorate(t,e,i,o);else for(var p=t.length-1;p>=0;p--)(a=t[p])&&(l=(n<3?a(l):n>3?a(e,i,l):a(e,i))||l);return n>3&&l&&Object.defineProperty(e,i,l),l};let c=class extends x{render(){return this.style.cssText=`
      ...
      width: ${this.width};
    `,E`<slot></slot>`}};c.styles=[y,D];g([s()],c.prototype,"flexDirection",void 0);g([s()],c.prototype,"flexWrap",void 0);g([s()],c.prototype,"flexBasis",void 0);g([s()],c.prototype,"flexGrow",void 0);g([s()],c.prototype,"flexShrink",void 0);g([s()],c.prototype,"alignItems",void 0);g([s()],c.prototype,"justifyContent",void 0);g([s()],c.prototype,"columnGap",void 0);g([s()],c.prototype,"rowGap",void 0);g([s()],c.prototype,"gap",void 0);g([s()],c.prototype,"padding",void 0);g([s()],c.prototype,"margin",void 0);g([s()],c.prototype,"width",void 0);c=g([P("wui-flex")],c);const M=Symbol.for(""),O=t=>{if(t?.r===M)return t?._$litStatic$},R=t=>({_$litStatic$:t,r:M}),b=new Map,B=t=>(e,...i)=>{const o=i.length;let n,l;const a=[],p=[];let d,u=0,m=!1;for(;u<o;){for(d=e[u];u<o&&(l=i[u],(n=O(l))!==void 0);)d+=n+e[++u],m=!0;u!==o&&p.push(l),a.push(d),u++}if(u===o&&a.push(e[o]),m){const H=a.join("$$lit$$");(e=b.get(H))===void 0&&(a.raw=a,b.set(H,e=a)),i=p}return t(e,...i)},S=B(E),z=h`<svg width="30" height="30" viewBox="0 0 30 30" fill="none">
...
`,G=h`<svg width="30" height="30" viewBox="0 0 30 30" fill="none">
...
</svg>`,N=h`<svg fill="none" viewBox="0 0 40 40">
  <g clip-path="url(#a)">
    <g clip-path="url(#b)">
...
>
  ...
  />
</svg>`,Q=h` <svg width="27" height="30" viewBox="0 0 27 30" fill="none">
...
</svg>`,t1=h`<svg width="75" height="20" viewBox="0 0 75 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,i1=h`<svg width="32" height="32" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
  <g clip-path="url(#a)">
...
`,o1=h`<svg fill="none" viewBox="0 0 40 40">
  <g clip-path="url(#a)">
    <g clip-path="url(#b)">
...
</svg>`,l1=h`<svg fill="none" viewBox="0 0 16 16">
  <path
    fill="currentColor"
    d="m14.36 4.74.01.42c0 4.34-3.3 9.34-9.34 9.34A9.3 9.3 0 0 1 0 13.03a6.6 6.6 0 0 0 4.86-1.36 3.29 3.29 0 0 1-3.07-2.28c.5.1 1 .07 1.48-.06A3.28 3.28 0 0 1 .64 6.11v-.04c.46.26.97.4 1.49.41A3.29 3.29 0 0 1 1.11 2.1a9.32 9.32 0 0 0 6.77 3.43 3.28 3.28 0 0 1 5.6-3 6.59 6.59 0 0 0 2.08-.8 3.3 3.3 0 0 1-1.45 1.82A6.53 6.53 0 0 0 16 3.04c-.44.66-1 1.23-1.64 1.7Z"
  />
</svg>`,n1=h`<svg fill="none" viewBox="0 0 20 20">
  <path
    fill="currentColor"
    fill-rule="evenodd"
...
`;var $=function(t,e,i,o){var n=arguments.length,l=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")l=Reflect.decorate(t,e,i,o);else for(var p=t.length-1;p>=0;p--)(a=t[p])&&(l=(n<3?a(l):n>3?a(e,i,l):a(e,i))||l);return n>3&&l&&Object.defineProperty(e,i,l),l};const f1={add:"ph-plus",allWallets:"ph-dots-three",arrowBottom:"ph-arrow-down",arrowBottomCircle:"ph-arrow-circle-down",arrowClockWise:"ph-arrow-clockwise",arrowLeft:"ph-arrow-left",arrowRight:"ph-arrow-right",arrowTop:"ph-arrow-up",arrowTopRight:"ph-arrow-up-right",bank:"ph-bank",bin:"ph-trash",browser:"ph-browser",card:"ph-credit-card",checkmark:"ph-check",checkmarkBold:"ph-check",chevronBottom:"ph-caret-down",chevronLeft:"ph-caret-left",chevronRight:"ph-caret-right",chevronTop:"ph-caret-up",clock:"ph-clock",close:"ph-x",coinPlaceholder:"ph-circle-half",compass:"ph-compass",copy:"ph-copy",desktop:"ph-desktop",dollar:"ph-currency-dollar",download:"ph-vault",exclamationCircle:"ph-warning-circle",extension:"ph-puzzle-piece",externalLink:"ph-arrow-square-out",filters:"ph-funnel-simple",helpCircle:"ph-question",id:"ph-identification-card",image:"ph-image",info:"ph-info",lightbulb:"ph-lightbulb",mail:"ph-envelope",mobile:"ph-device-mobile",more:"ph-dots-three",networkPlaceholder:"ph-globe",nftPlaceholder:"ph-image",plus:"ph-plus",power:"ph-power",qrCode:"ph-qr-code",questionMark:"ph-question",refresh:"ph-arrow-clockwise",recycleHorizontal:"ph-arrows-clockwise",search:"ph-magnifying-glass",sealCheck:"ph-seal-check",send:"ph-paper-plane-right",signOut:"ph-sign-out",spinner:"ph-spinner",swapHorizontal:"ph-arrows-left-right",swapVertical:"ph-arrows-down-up",threeDots:"ph-dots-three",user:"ph-user",verify:"ph-seal-check",verifyFilled:"ph-seal-check",warning:"ph-warning",warningCircle:"ph-warning-circle",appStore:"",apple:"",bitcoin:"",chromeStore:"",cursor:"",discord:"",ethereum:"",etherscan:"",facebook:"",farcaster:"",github:"",google:"",playStore:"",reown:"",solana:"",ton:"",telegram:"",twitch:"",twitterIcon:"",twitter:"",walletConnect:"",walletConnectBrown:"",walletConnectLightBrown:"",x:"",wallet:""},g1={"ph-arrow-circle-down":()=>r(()=>import("./PhArrowCircleDown-BtlNV0TZ.js"),__vite__mapDeps([0,1])),"ph-arrow-clockwise":()=>r(()=>import("./PhArrowClockwise-mOiWYLMV.js"),__vite__mapDeps([2,1])),"ph-arrow-down":()=>r(()=>import("./PhArrowDown-CkoOD89h.js"),__vite__mapDeps([3,1])),"ph-arrow-left":()=>r(()=>import("./PhArrowLeft-C0jlxVhM.js"),__vite__mapDeps([4,1])),"ph-arrow-right":()=>r(()=>import("./PhArrowRight-BI-V03Xf.js"),__vite__mapDeps([5,1])),"ph-arrow-square-out":()=>r(()=>import("./PhArrowSquareOut-DnQ7n_B4.js"),__vite__mapDeps([6,1])),"ph-arrows-down-up":()=>r(()=>import("./PhArrowsDownUp-PZosTqZG.js"),__vite__mapDeps([7,1])),"ph-arrows-left-right":()=>r(()=>import("./PhArrowsLeftRight-CYsRQ2qh.js"),__vite__mapDeps([8,1])),"ph-arrow-up":()=>r(()=>import("./PhArrowUp-izKvURUW.js"),__vite__mapDeps([9,1])),"ph-arrow-up-right":()=>r(()=>import("./PhArrowUpRight-Bn-JhHsY.js"),__vite__mapDeps([10,1])),"ph-arrows-clockwise":()=>r(()=>import("./PhArrowsClockwise-Brtx2Re-.js"),__vite__mapDeps([11,1])),"ph-bank":()=>r(()=>import("./PhBank-hhPAIPVb.js"),__vite__mapDeps([12,1])),"ph-browser":()=>r(()=>import("./PhBrowser-BjzAmrHO.js"),__vite__mapDeps([13,1])),"ph-caret-down":()=>r(()=>import("./PhCaretDown-ddSjwcwm.js"),__vite__mapDeps([14,1])),"ph-caret-left":()=>r(()=>import("./PhCaretLeft-B7YLoNEF.js"),__vite__mapDeps([15,1])),"ph-caret-right":()=>r(()=>import("./PhCaretRight-BY8D5MIg.js"),__vite__mapDeps([16,1])),"ph-caret-up":()=>r(()=>import("./PhCaretUp-BG10nSut.js"),__vite__mapDeps([17,1])),"ph-check":()=>r(()=>import("./PhCheck-DrKd7pBC.js"),__vite__mapDeps([18,1])),"ph-circle-half":()=>r(()=>import("./PhCircleHalf-Bk9C4DvT.js"),__vite__mapDeps([19,1])),"ph-clock":()=>r(()=>import("./PhClock-Sj17weCB.js"),__vite__mapDeps([20,1])),"ph-compass":()=>r(()=>import("./PhCompass-Df1ugFO-.js"),__vite__mapDeps([21,1])),"ph-copy":()=>r(()=>import("./PhCopy-rgttky8E.js"),__vite__mapDeps([22,1])),"ph-credit-card":()=>r(()=>import("./PhCreditCard-CZpdid2n.js"),__vite__mapDeps([23,1])),"ph-currency-dollar":()=>r(()=>import("./PhCurrencyDollar-B6IKKjue.js"),__vite__mapDeps([24,1])),"ph-desktop":()=>r(()=>import("./PhDesktop-BuCDXYJj.js"),__vite__mapDeps([25,1])),"ph-device-mobile":()=>r(()=>import("./PhDeviceMobile-CnybhXY-.js"),__vite__mapDeps([26,1])),"ph-dots-three":()=>r(()=>import("./PhDotsThree-CSAEcba1.js"),__vite__mapDeps([27,1])),"ph-vault":()=>r(()=>import("./PhVault-B8m1usHw.js"),__vite__mapDeps([28,1])),"ph-envelope":()=>r(()=>import("./PhEnvelope-SmaNeXoQ.js"),__vite__mapDeps([29,1])),"ph-funnel-simple":()=>r(()=>import("./PhFunnelSimple-DKx35ITq.js"),__vite__mapDeps([30,1])),"ph-globe":()=>r(()=>import("./PhGlobe-q1mqj65V.js"),__vite__mapDeps([31,1])),"ph-identification-card":()=>r(()=>import("./PhIdentificationCard-BeLXJpfZ.js"),__vite__mapDeps([32,1])),"ph-image":()=>r(()=>import("./PhImage-BYrKfN9k.js"),__vite__mapDeps([33,1])),"ph-info":()=>r(()=>import("./PhInfo-X33f06Ej.js"),__vite__mapDeps([34,1])),"ph-lightbulb":()=>r(()=>import("./PhLightbulb-DMZJsowR.js"),__vite__mapDeps([35,1])),"ph-magnifying-glass":()=>r(()=>import("./PhMagnifyingGlass-B6D0sWFL.js"),__vite__mapDeps([36,1])),"ph-paper-plane-right":()=>r(()=>import("./PhPaperPlaneRight-Dvo-nXr9.js"),__vite__mapDeps([37,1])),"ph-plus":()=>r(()=>import("./PhPlus-CBvZvLax.js"),__vite__mapDeps([38,1])),"ph-power":()=>r(()=>import("./PhPower-D8-AcNM6.js"),__vite__mapDeps([39,1])),"ph-puzzle-piece":()=>r(()=>import("./PhPuzzlePiece-C-7mYqGO.js"),__vite__mapDeps([40,1])),"ph-qr-code":()=>r(()=>import("./PhQrCode-uIXlI5ER.js"),__vite__mapDeps([41,1])),"ph-question":()=>r(()=>import("./PhQuestion-rUoqC2sC.js"),__vite__mapDeps([42,1])),"ph-question-circle":()=>r(()=>import("./PhQuestionMark-W55Txvvb.js"),__vite__mapDeps([43,1])),"ph-seal-check":()=>r(()=>import("./PhSealCheck-BeVLq9PH.js"),__vite__mapDeps([44,1])),"ph-sign-out":()=>r(()=>import("./PhSignOut-Cq2PivQ6.js"),__vite__mapDeps([45,1])),"ph-spinner":()=>r(()=>import("./PhSpinner-CZMtAFdX.js"),__vite__mapDeps([46,1])),"ph-trash":()=>r(()=>import("./PhTrash-BamrmMsN.js"),__vite__mapDeps([47,1])),"ph-user":()=>r(()=>import("./PhUser-A2fxqIV0.js"),__vite__mapDeps([48,1])),"ph-warning":()=>r(()=>import("./PhWarning-CpkID9oi.js"),__vite__mapDeps([49,1])),"ph-warning-circle":()=>r(()=>import("./PhWarningCircle-Cm58gXb9.js"),__vite__mapDeps([50,1])),"ph-x":()=>r(()=>import("./PhX-C3b4cCEy.js"),__vite__mapDeps([51,1]))},u1={appStore:z,apple:F,bitcoin:U,chromeStore:G,cursor:j,discord:N,ethereum:W,etherscan:q,facebook:X,farcaster:Y,github:J,google:K,playStore:Q,reown:t1,solana:e1,ton:r1,telegram:i1,twitch:o1,twitter:V,twitterIcon:l1,walletConnect:a1,walletConnectInvert:h1,walletConnectBrown:p1,walletConnectLightBrown:s1,x:V,wallet:n1},d1={"accent-primary":f.tokens.core.iconAccentPrimary,"accent-certified":f.tokens.core.iconAccentCertified,default:f.tokens.theme.iconDefault,success:f.tokens.core.iconSuccess,error:f.tokens.core.iconError,warning:f.tokens.core.iconWarning,inverse:f.tokens.theme.iconInverse};let w=class extends x{constructor(){super(...arguments),this.size="md",this.name="copy",this.weight="bold",this.color="inherit"}render(){const e={xxs:"2",xs:"3",sm:"3",md:"4",mdl:"5",lg:"5",xl:"6",xxl:"7",inherit:"inherit"};this.style.cssText=`
      --local-width: ${this.size==="inherit"?"inherit":`var(--apkt-spacing-${e[this.size]})`};
      --local-color: ${this.color==="inherit"?"inherit":d1[this.color]}
    `;const i=f1[this.name];if(i&&i!==""){const o=g1[i];o&&o();const n=R(i);return S`<${n} size=${{xxs:"0.5em",xs:"0.75em",sm:"0.75em",md:"1em",mdl:"1.25em",lg:"1.25em",xl:"1.5em",xxl:"1.75em"}[this.size]} weight="${this.weight}"></${n}>`}return u1[this.name]||S``}};w.styles=[y,c1];$([s()],w.prototype,"size",void 0);$([s()],w.prototype,"name",void 0);$([s()],w.prototype,"weight",void 0);$([s()],w.prototype,"color",void 0);w=$([P("wui-icon")],w);const m1=Z`
  slot {
    width: 100%;
...
`;var C=function(t,e,i,o){var n=arguments.length,l=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")l=Reflect.decorate(t,e,i,o);else for(var p=t.length-1;p>=0;p--)(a=t[p])&&(l=(n<3?a(l):n>3?a(e,i,l):a(e,i))||l);return n>3&&l&&Object.defineProperty(e,i,l),l};const v1={primary:f.tokens.theme.textPrimary,secondary:f.tokens.theme.textSecondary,tertiary:f.tokens.theme.textTertiary,invert:f.tokens.theme.textInvert,error:f.tokens.core.textError,warning:f.tokens.core.textWarning,"accent-primary":f.tokens.core.textAccentPrimary};let _=class extends x{constructor(){super(...arguments),this.variant="md-regular",this.color="inherit",this.align="left",this.lineClamp=void 0,this.display="inline-flex"}render(){const e={[`wui-font-${this.variant}`]:!0,[`wui-line-clamp-${this.lineClamp}`]:!!this.lineClamp};return this.style.cssText=`
      display: ${this.display};
      --local-align: ${this.align};
      --local-color: ${this.color==="inherit"?"inherit":v1[this.color??"primary"]};
      `,E`<slot class=${A(e)}></slot>`}};_.styles=[y,m1];C([s()],_.prototype,"variant",void 0);C([s()],_.prototype,"color",void 0);C([s()],_.prototype,"align",void 0);C([s()],_.prototype,"lineClamp",void 0);C([s()],_.prototype,"display",void 0);_=C([P("wui-text")],_);export{v as U,P as c,r1 as t};
