import{w as d,p as h,s as f,i as g,o as w,t as b,x as y}from"./chain_config-D8DYnceI.js";import{r as m}from"./class-map-gEppeFCC.js";import{c as x}from"./index-Cd3y1h9a.js";const o=h({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),v={state:o,subscribe(t){return g(o,()=>t(o))},subscribeKey(t,e){return f(o,t,e)},showTooltip({message:t,triggerRect:e,variant:i}){o.open=!0,o.message=t,o.triggerRect=e,o.variant=i},hide(){o.open=!1,o.message="",o.triggerRect={width:0,height:0,top:0,left:0}}},s=d(v),$=w`
  :host {
    pointer-events: none;
  }
