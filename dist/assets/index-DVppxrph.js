import{o as v,r as I,q as W,t as f,x as l,C as u,O as m,b9 as Oe,af as E,a as b,ac as O,u as oe,E as C,ap as ke,H as g,z as k,R as h,d as P,S as A,y,A as Xe,W as Qe,bY as ye,bZ as Se,b_ as te,ar as Yi,aE as $,b$ as Ne,F as Ni,aG as Xi,aF as Qi,aD as Ji,ag as $t,bg as ti,bh as ii,c0 as Zi,bj as Ht,c1 as en}from"./chain_config-D8DYnceI.js";import{n as c,r as d,a as Oi}from"./class-map-gEppeFCC.js";import{o as w}from"./if-defined-B79U8La_.js";import{c as p,U}from"./index-Cd3y1h9a.js";import"./index-B45DtCSQ.js";import"./index-Dv3DgHfk.js";import"./index-C58ZByqQ.js";import"./index-DHFsNE39.js";import{a as Ta,W as Ra}from"./index-o6_RijN9.js";import"./index--9RDAjl5.js";import"./index-N0djxW3t.js";import"./index-CtaD59Sl.js";import{H as ni}from"./HelpersUtil-MCJZFBhD.js";import{E as ee}from"./ExchangeController--y7KD5qp.js";import"./index-CVRcUqwi.js";import"./index-TE9UVXpb.js";import{M as Ct}from"./index-DmQodiCc.js";import"./index-DrWzjmNV.js";import"./index-BiHCrKqT.js";import"./index-CkFUCH1c.js";import{e as oi,n as ri}from"./ref-Dfiam_TO.js";import"./index-gGLWbcjs.js";import{n as tn}from"./index-DSfiV4fZ.js";import"./index-CyGrdyG0.js";import"./index-ngR0JE7y.js";import"./index-fxhu_x-1.js";import{O as St}from"./index-DS6nAclk.js";import{e as nn}from"./index-BltiFOpx.js";import"./index-D5ZHVyzg.js";import"./index-COpTZOy_.js";import"./index-B1xXBZHu.js";import{N as on}from"./NavigationUtil-DmfK5sOV.js";import"./index-CY8cTnny.js";import"./updateLocale-29SaZsIG.js";import"./async-directive-vLOJ1iU1.js";import"./browser-YnLq1ntR.js";const rn=v`
  :host {
    display: block;
  }
...
`;var Bi=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var s=t.length-1;s>=0;s--)(a=t[s])&&(n=(r<3?a(n):r>3?a(e,i,n):a(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let At=class extends f{constructor(){super(...arguments),this.type="wallet"}render(){return l`
    ...
    `}shimmerTemplate(){return this.type==="network"?l` <wui-shimmer data-type=${this.type} width="48px" height="54px"></wui-shimmer>
        ${tn}`:l`<wui-shimmer width="56px" height="56px"></wui-shimmer>`}};At.styles=[I,W,Nn];Bi([c()],At.prototype,"type",void 0);At=Bi([p("wui-card-select-loader")],At);const On=oe`
  :host {
    display: grid;
    width: inherit;
    height: inherit;
...
`;var xt=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var s=t.length-1;s>=0;s--)(a=t[s])&&(n=(r<3?a(n):r>3?a(e,i,n):a(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let He=class extends f{constructor(){super(),this.unsubscribe=[],this.network=u.state.activeCaipNetwork,this.requestedCaipNetworks=u.getCaipNetworks(),this.search="",this.onDebouncedSearch=b.debounce(e=>{this.search=e},100),this.unsubscribe.push(Oe.subscribeNetworkImages(()=>this.requestUpdate()),u.subscribeKey("activeCaipNetwork",e=>this.network=e),u.subscribe(()=>{this.requestedCaipNetworks=u.getAllRequestedCaipNetworks()}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){return l`
    ...
    `}onInputChange(e){this.onDebouncedSearch(e.detail)}networksTemplate(){const e=u.getAllApprovedCaipNetworkIds(),i=b.sortRequestedNetworks(e,this.requestedCaipNetworks);return this.search?this.filteredNetworks=i?.filter(o=>o?.name?.toLowerCase().includes(this.search.toLowerCase())):this.filteredNetworks=i,this.filteredNetworks?.map(o=>l`
        ...
        ></wui-list-network>
      `)}onSwitchNetwork(e){en.onSwitchNetwork({network:e})}};He.styles=po;xt([d()],He.prototype,"network",void 0);xt([d()],He.prototype,"requestedCaipNetworks",void 0);xt([d()],He.prototype,"filteredNetworks",void 0);xt([d()],He.prototype,"search",void 0);He=xt([p("w3m-networks-view")],He);const wo=v`
  @keyframes shake {
    0% {
      transform: translateX(0);
    }
...
`;var So=function(t,e,i,o){var r=arguments.length,n=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,i):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,i,o);else for(var s=t.length-1;s>=0;s--)(a=t[s])&&(n=(r<3?a(n):r>3?a(e,i,n):a(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n};let ei=class extends f{constructor(){super(...arguments),this.dappImageUrl=m.state.metadata?.icons,this.walletImageUrl=u.getAccountData()?.connectedWalletInfo?.icon}firstUpdated(){const e=this.shadowRoot?.querySelectorAll("wui-visual-thumbnail");e?.[0]&&this.createAnimation(e[0],"translate(18px)"),e?.[1]&&this.createAnimation(e[1],"translate(-18px)")}render(){return l`
    ...
    `}async onSign(){this.isSigning=!0;try{await Ht.requestSignMessage()}catch(e){if(e instanceof Error&&e.message.includes("OTP is required")){A.showError({message:"Something went wrong. We need to verify your account again."}),h.replace("DataCapture");return}throw e}finally{this.isSigning=!1}}async onCancel(){this.isCancelling=!0,await Ht.cancelSignMessage().finally(()=>this.isCancelling=!1)}};pi([d()],Lt.prototype,"isCancelling",void 0);pi([d()],Lt.prototype,"isSigning",void 0);Lt=pi([p("w3m-siwx-sign-message-view")],Lt);export{fi as AppKitAccountButton,bi as AppKitButton,yi as AppKitConnectButton,xi as AppKitNetworkButton,wi as W3mAccountButton,Ee as W3mAccountSettingsView,Gt as W3mAccountView,It as W3mAllWalletsView,mi as W3mButton,Ot as W3mChooseAccountNameView,gi as W3mConnectButton,K as W3mConnectView,Pt as W3mConnectWalletsView,ki as W3mConnectingExternalView,Wt as W3mConnectingMultiChainView,Nt as W3mConnectingWcBasicView,xe as W3mConnectingWcView,_i as W3mDownloadsView,Ta as W3mFooter,Ue as W3mFundWalletView,Wi as W3mGetWalletView,vi as W3mNetworkButton,ht as W3mNetworkSwitchView,He as W3mNetworksView,z as W3mProfileWalletsView,Ra as W3mRouter,Lt as W3mSIWXSignMessageView,Dt as W3mSwitchActiveChainView,pt as W3mUnsupportedChainView,Zt as W3mWalletCompatibleNetworksView,Ri as W3mWhatIsANetworkView,Ti as W3mWhatIsAWalletView};
