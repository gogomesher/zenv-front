import{u as H,t as g,ac as W,O as K,x as c,H as _,ag as j,b4 as G,o as E,r as U,q as Y,d as N,C as m,b5 as V,z as k,A as C,W as h,y as L,b6 as q,b7 as v,a as z,E as O,S as X,R as Q}from"./chain_config-D8DYnceI.js";import{r as d,n as l}from"./class-map-gEppeFCC.js";import{c as w}from"./index-Cd3y1h9a.js";import"./index-B45DtCSQ.js";import{e as Z,n as J}from"./ref-Dfiam_TO.js";import"./index-Dv3DgHfk.js";import{H as I}from"./HelpersUtil-MCJZFBhD.js";import{o as ee}from"./if-defined-B79U8La_.js";import"./index-gGLWbcjs.js";import"./index--9RDAjl5.js";import"./index-CtaD59Sl.js";import"./index-DHFsNE39.js";import"./index-D5ZHVyzg.js";import{N as te}from"./NavigationUtil-DmfK5sOV.js";import"./async-directive-vLOJ1iU1.js";const ie=H`
  div {
    width: 100%;
  }
...
`;var x=function(e,t,i,r){var n=arguments.length,o=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(n<3?s(o):n>3?s(t,i,o):s(t,i))||o);return n>3&&o&&Object.defineProperty(t,i,o),o};let p=class extends g{constructor(){super(),this.formRef=Z(),this.usubscribe=[],this.name="",this.error="",this.loading=v.state.loading,this.suggestions=v.state.suggestions,this.profileName=m.getAccountData()?.profileName,this.onDebouncedNameInputChange=z.debounce(t=>{t.length<4?this.error="Name must be at least 4 characters long":I.isValidReownName(t)?(this.error="",v.getSuggestions(t)):this.error="The value is not a valid username"}),this.usubscribe.push(v.subscribe(t=>{this.suggestions=t.suggestions,this.loading=t.loading}),m.subscribeChainProp("accountState",t=>{this.profileName=t?.profileName,t?.profileName&&(this.error="You already own a name")}))}firstUpdated(){this.formRef.value?.addEventListener("keydown",this.onEnterKey.bind(this))}disconnectedCallback(){super.disconnectedCallback(),this.usubscribe.forEach(t=>t()),this.formRef.value?.removeEventListener("keydown",this.onEnterKey.bind(this))}render(){return c`
      <wui-flex
...
`;var pe=function(e,t,i,r){var n=arguments.length,o=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(n<3?s(o):n>3?s(t,i,o):s(t,i))||o);return n>3&&o&&Object.defineProperty(t,i,o),o};let D=class extends g{render(){return c`
    ...
    </wui-flex>`}redirectToAccount(){Q.replace("Account")}};D.styles=ue;D=pe([w("w3m-register-account-name-success-view")],D);export{R as W3mApproveTransactionView,D as W3mRegisterAccountNameSuccess,p as W3mRegisterAccountNameView,$ as W3mSmartAccountSettingsView,B as W3mUpgradeWalletView};
