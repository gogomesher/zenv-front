import{w as d,p as h,s as f,i as g,l as w,n as b,x as y}from"./index-B0RynRNr.js";import{r as m}from"./class-map-BKD9lMKe.js";import{c as x}from"./index-Brwreh6R.js";const o=h({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),v={state:o,subscribe(t){return g(o,()=>t(o))},subscribeKey(t,e){return f(o,t,e)},showTooltip({message:t,triggerRect:e,variant:i}){o.open=!0,o.message=t,o.triggerRect=e,o.variant=i},hide(){o.open=!1,o.message="",o.triggerRect={width:0,height:0,top:0,left:0}}},s=d(v),$=w`
  :host {
    pointer-events: none;
  }
