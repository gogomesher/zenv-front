import{o as g,r as v,q as $,t as k,x as l,C as c,S as p,af as m,ag as h,A as C,W as N,R,a as A}from"./chain_config-D8DYnceI.js";import{n as x,r as f}from"./class-map-gEppeFCC.js";import{o as S}from"./if-defined-B79U8La_.js";import{c as y,U as I}from"./index-Cd3y1h9a.js";import"./index-B45DtCSQ.js";import"./index-B1xXBZHu.js";import"./browser-YnLq1ntR.js";const T=g`
  button {
    width: 100%;
    display: flex;
    align-items: center;
...
`;var b=function(e,t,o,r){var s=arguments.length,i=s<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,o):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,r);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(i=(s<3?n(i):s>3?n(t,o,i):n(t,o))||i);return s>3&&i&&Object.defineProperty(t,o,i),i};let d=class extends k{constructor(){super(...arguments),this.networkImages=[""],this.text=""}render(){return l`
    ...
    </wui-flex>`}};d.styles=[v,$,T];b([x({type:Array})],d.prototype,"networkImages",void 0);b([x()],d.prototype,"text",void 0);d=b([y("wui-compatible-network")],d);const O=g`
    ...
    >
      ...
      >
        <wui-qr-code
          ...
          uri=${this.address}
          ?arenaClear=${!0}
          color=${S(h.state.themeVariables["--apkt-qr-color"]??h.state.themeVariables["--w3m-qr-color"])}
      ...
      .networkImages=${n}
    ></wui-compatible-network>`}onReceiveClick(){R.push("WalletCompatibleNetworks")}onCopyClick(){try{this.address&&(A.copyToClopboard(this.address),p.showSuccess("Address copied"))}catch{p.showError("Failed to copy")}}};u.styles=O;w([f()],u.prototype,"address",void 0);w([f()],u.prototype,"profileName",void 0);w([f()],u.prototype,"network",void 0);u=w([y("w3m-wallet-receive-view")],u);export{u as W3mWalletReceiveView};
