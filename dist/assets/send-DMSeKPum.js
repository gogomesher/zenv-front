import{o as f,n as w,Y as I,V as x,M as H,bf as l,x as u,F as z,G as W,K as g,H as L,ad as q,L as _,Q as M,T as Y,U as K}from"./index-B0RynRNr.js";import{n as d,r as c}from"./class-map-BKD9lMKe.js";import{c as m,U as $}from"./index-D1DpIkmA.js";import"./index-Bf_SjFc6.js";import"./index-B2xGJ35h.js";import{e as O,n as D}from"./ref-Bs-cfaPF.js";import"./index-BAa-drCU.js";import{n as G,s as Q}from"./ConstantsUtil-Dmg8YACJ.js";import"./index-zHpK0vul.js";import"./index-Bce24cBw.js";import{S as F}from"./SwapController-Dv4ymab2.js";import"./index-CMcdcRgj.js";import"./index-BbUgdJ-S.js";import"./index-C1deNAl8.js";import"./index-Cn9rIZ3w.js";import{o as J}from"./if-defined-BrvS5P3j.js";import"./index-CJd_XbGZ.js";import"./async-directive-B406kvJw.js";import"./index-Btu9FXa8.js";const X=f`
  :host {
    width: 100%;
    height: 100px;
...
`;var B=function(o,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(o,e,i,n);else for(var a=o.length-1;a>=0;a--)(s=o[a])&&(t=(r<3?s(t):r>3?s(e,i,t):s(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let C=class extends w{constructor(){super(...arguments),this.inputElementRef=O(),this.disabled=!1,this.value="",this.placeholder="0"}render(){return this.inputElementRef?.value&&this.value&&(this.inputElementRef.value.value=this.value),u`<input
    ...
    /> `}dispatchInputChangeEvent(e){const i=e.data;if(i&&this.inputElementRef?.value)if(i===","){const n=this.inputElementRef.value.value.replace(",",".");this.inputElementRef.value.value=n,this.value=`${this.value}${n}`}else G.test(i)||(this.inputElementRef.value.value=this.value.replace(new RegExp(i.replace(Q,"\\$&"),"gu"),""));this.dispatchEvent(new CustomEvent("inputChange",{detail:this.inputElementRef.value?.value,bubbles:!0,composed:!0}))}};C.styles=[z,W,Z];B([d({type:Boolean})],C.prototype,"disabled",void 0);B([d({type:String})],C.prototype,"value",void 0);B([d({type:String})],C.prototype,"placeholder",void 0);C=B([m("wui-input-amount")],C);const ee=f`
  :host {
    width: 100%;
    height: 100px;
    border-radius: var(--wui-border-radius-s);
