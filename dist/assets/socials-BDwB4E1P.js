import{u as k,t as _,a8 as $,ak as u,Q as w,a6 as U,x as l,a1 as P,aI as F,a4 as A,a3 as d,U as E,$ as y,ab as D,X as p,aq as W,T as b,aJ as N,ae as O,ai as S}from"./chain_config-D8DYnceI.js";import{n as j,r as c}from"./class-map-gEppeFCC.js";import{o as C}from"./if-defined-B79U8La_.js";import{c as I}from"./index-CAF11AxJ.js";import{O as R}from"./index-CDzzw6KV.js";import{e as q}from"./index-DuGaLMtx.js";import"./index-S9s5RHv-.js";import"./index-C7IIus8o.js";import"./index-CLIq9jXF.js";import"./index-BP5oJskm.js";import"./index-Bdd7oWFu.js";import"./index-C9xcjpaH.js";import"./index-CSdExni1.js";import"./ref-Dfiam_TO.js";import"./async-directive-vLOJ1iU1.js";import"./ConstantsUtil-Dmg8YACJ.js";import"./index-DSM72A0H.js";import"./index-BBtbNsVY.js";import"./browser-YnLq1ntR.js";const M=k`
  :host {
...
`;var v=function(n,e,t,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,t,o);else for(var a=n.length-1;a>=0;a--)(s=n[a])&&(i=(r<3?s(i):r>3?s(e,t,i):s(e,t))||i);return r>3&&i&&Object.defineProperty(e,t,i),i};let m=class extends _{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=$.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.remoteFeatures=u.state.remoteFeatures,this.isPwaLoading=!1,this.unsubscribe.push($.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(t=>t.type==="AUTH")}),u.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=this.remoteFeatures?.socials||[];const t=!!this.authConnector,o=e?.length,r=w.state.view==="ConnectSocials";return(!t||!o)&&!r?null:(r&&!o&&(e=U.DEFAULT_SOCIALS),l` <wui-flex flexDirection="column" gap="xs">
      ${e.map(i=>l`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){e&&await q(e)}async handlePwaFrameLoad(){if(P.isPWA()){this.isPwaLoading=!0;try{this.authConnector?.provider instanceof F&&await this.authConnector.provider.init()}catch(e){A.open({displayMessage:"Error loading embedded wallet in PWA",debugMessage:e.message},"error")}finally{this.isPwaLoading=!1}}}};m.styles=M;v([j()],m.prototype,"tabIdx",void 0);v([c()],m.prototype,"connectors",void 0);v([c()],m.prototype,"authConnector",void 0);v([c()],m.prototype,"remoteFeatures",void 0);v([c()],m.prototype,"isPwaLoading",void 0);m=v([I("w3m-social-login-list")],m);const z=k`
  wui-flex {
