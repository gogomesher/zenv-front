import{M as g,P as m,a9 as w,aa as f,u as v,t as b,x}from"./chain_config-D8DYnceI.js";import{r as u}from"./class-map-gEppeFCC.js";import{c as h}from"./index-CAF11AxJ.js";import"./index-BP5oJskm.js";const e=m({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),y={state:e,subscribe(o){return f(e,()=>o(e))},subscribeKey(o,t){return w(e,o,t)},showTooltip({message:o,triggerRect:t,variant:i}){e.open=!0,e.message=o,e.triggerRect=t,e.variant=i},hide(){e.open=!1,e.message="",e.triggerRect={width:0,height:0,top:0,left:0}}},s=g(y),R=v`
  :host {
    pointer-events: none;
  }
