import{l as u,r as h,m as f,n as p,x as m}from"./index-B0RynRNr.js";import{n as d}from"./class-map-BKD9lMKe.js";import{o as g}from"./if-defined-BrvS5P3j.js";import{c as b}from"./index-Brwreh6R.js";const y=u`
  :host {
    display: inline-flex;
...
`;var a=function(o,e,c,n){var i=arguments.length,r=i<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,c):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(o,e,c,n);else for(var l=o.length-1;l>=0;l--)(s=o[l])&&(r=(i<3?s(r):i>3?s(e,c,r):s(e,c))||r);return i>3&&r&&Object.defineProperty(e,c,r),r};let t=class extends p{constructor(){super(...arguments),this.icon="copy",this.size="md",this.padding="1",this.color="default"}render(){return this.dataset.padding=this.padding,this.dataset.color=this.color,m`
      <wui-icon size=${g(this.size)} name=${this.icon} color="inherit"></wui-icon>
    `}};t.styles=[h,f,y];a([d()],t.prototype,"icon",void 0);a([d()],t.prototype,"size",void 0);a([d()],t.prototype,"padding",void 0);a([d()],t.prototype,"color",void 0);t=a([b("wui-icon-box")],t);
